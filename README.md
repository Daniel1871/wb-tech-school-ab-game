...
- Я говорил ранее, что во время проведения эксперимента прибыль не меняется в зависимости от изменений, сделанных для тестовой группы эксперимента ⇒ ухудшение конверсии в экспериментах нас не пугает в плане того, что нужно резко все прерывать; и длительные тесты не несут для нас финансовых потерь в этой игре. 
