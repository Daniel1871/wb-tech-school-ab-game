...
Очевидно, что если нам интересно максимизировать прибыль, то фиксация момента, когды мы принимаем решения, нам в данной игре (подчеркиваю, что не в реальной жизни) не помогает.
